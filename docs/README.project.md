...
Приложение для Android TV, которое показывает новые релизы и избранные сериалы с [lostfilm.today](https://www.lostfilm.today) в удобном интерфейсе для пульта дистанционного управления.
...
- 📺 **Новые релизы** — лента свежих серий и фильмов прямо с lostfilm.today
...
| Главный экран | Детали релиза | Гид по сериям |
|:---:|:---:|:---:|
| Новые релизы / Избранное | Постер, торрент-ссылки, избранное | Все сезоны с отметками просмотра |
...
| **Аккаунт LostFilm** | Необязателен для просмотра новинок, требуется для Избранного |
