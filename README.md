...
Android TV приложение для просмотра новых релизов, фильмов и избранных сериалов LostFilm в интерфейсе, рассчитанном на управление пультом.

## Что умеет приложение

- Показывает новые релизы и фильмы с `lostfilm.today`
...
|---|---|
| ![Главный экран с новыми релизами](docs/screenshots/home.png) | ![Экран фильмов с пометками скоро](docs/screenshots/movies.png) |
...
|---|---|
| ![Гид по сериям](docs/screenshots/guide.png) | ![Экран настроек](docs/screenshots/settings.png) |

| QR-авторизация |
|---|---|
| ![Экран QR-авторизации](docs/screenshots/auth.png) |
...
- Home: новые релизы, избранное и фильмы с переключением режимов
- Details: карточка релиза, постер, описания, раздачи, действия
- Series Overview: обзор сериала, описание, сюжет и метаданные
