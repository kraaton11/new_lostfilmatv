...
fun SettingsRoute(
    ...
    SettingsScreen(
        ...
        onSaveTorrServeBaseUrlClick = viewModel::onSaveTorrServeBaseUrlClick,
        onCheckTorrServeClick = viewModel::onCheckTorrServeClick,
        onResetTorrServeBaseUrlClick = viewModel::onResetTorrServeBaseUrlClick,
        dataStatusText = state.value.dataStatusText,
        isDataActionRunning = state.value.isDataActionRunning,
        onRefreshDataClick = viewModel::onRefreshDataClick,
        onClearReleaseCacheClick = viewModel::onClearReleaseCacheClick,
        onClearPosterCacheClick = viewModel::onClearPosterCacheClick,
        onClearNetworkCacheClick = viewModel::onClearNetworkCacheClick,
